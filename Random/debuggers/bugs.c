...
int main(int argc, char** argv) {
  ...
  //************************************************************************ BUG #1 Added a NULL pointer to signal end of sentence
  ...
  free(bug_info.sentence[2]);
  //*************************************************************************BUG #5 Removed dangling pointer accessed in bugs.c:156
  ...
  //************************************************************************ BUG #4 dont need to free memory not allocated by malloc
